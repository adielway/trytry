...
<body>
  <div class="sidebar" id="sidebar">
    ...
    <a href="manage_advisers.php"><i class="bi bi-people"></i> Manage Advisers</a>
    <a href="assign_students.php" class="active"><i class="bi bi-person-lines-fill"></i> Assign Students</a>
